...
<div class="reserBox">
    	<div class="col">
            <h3>安排会议</h3>
            <div class="colBox">
                <form id="reserForm" name="reserForm" method='post' action='/company/do_public_reservation' onsubmit="return do_open_meeting(this)">
                <input type='hidden' name='user_list'>
                    <ul>
                        ...
                        <li>
                            <div>会议人数</div>
                             <input name='usercount' class='year' value='<?php echo $usercount?>' />
                        </li>
                        <li>
                            <div>会议密码</div>
